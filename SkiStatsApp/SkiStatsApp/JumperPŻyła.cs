...
{
    public class JumperPŻyła : JumperBase
    {
        public override event JumpLenghtDelegate JumpAdded;

        private const string fileNamePiotrŻyła = "PiotrŻyła.txt";

        public JumperPŻyła(string name, string surname)
           : base(name, surname)
        {
        }
        public override void AddDistance(float distance)
        {
            ...
            {
                using (var writer = File.AppendText(fileNamePiotrŻyła))
                {
        ...
        public override Statistics GetStatistics()
        {
            ...
            if (File.Exists(fileNamePiotrŻyła))
            {
                using (var reader = File.OpenText(fileNamePiotrŻyła))
                {
